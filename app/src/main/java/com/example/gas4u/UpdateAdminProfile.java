...
import com.example.gas4u.databinding.ActivityUpdateAdminProfileBinding;
...
public class UpdateAdminProfile extends AppCompatActivity {
    ...
    ActivityUpdateAdminProfileBinding activityUpdateAdminProfileBinding;
    ImageView userPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityUpdateAdminProfileBinding.userPhoto.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
    ...
    ActivityResultLauncher<String> launcher = registerForActivityResult(new ActivityResultContracts.GetContent(), new ActivityResultCallback<Uri>() {
        ...
        public void onActivityResult(Uri result) {
            activityUpdateAdminProfileBinding.userPhoto.setImageURI(result);
            image_uri = result;
        }
    });
}